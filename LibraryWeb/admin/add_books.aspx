<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="add_books.aspx.cs" Inherits="LibraryWeb.admin.add_books" %>
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  ...
                                  <form action="" id="fo1" runat="server" method="post" novalidate="novalidate">
                                      ...
                                      <div class="form-group">
                                          <label for="" class="control-label mb-1">Books Isbnc</label>
                                      ...
                                      <div>
                                          ...
                                          <asp:Button ID="b1" runat="server" class="btn btn-lg btn-info btn-block" Text="Add Books" OnClick="b1_Click1"/> 
                                      </div>
