<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="LibraryWeb.admin.login" %>
...
<head>
    ...
    <title>Visual Library - HTML5 Admin Template</title>
                ...
                <div class="login-form">
                    <form id="f1" runat="server">
                        ...
                        <div class="alert alert-danger" id="error" runat="server" style="margin-top:10px; display:none">
                                 <strong>You have entered invalid user name or password</strong>
                            </div>
                    </form>
                </div>
            </div>
